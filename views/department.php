...
$department->post('create', function ($data) {
    ...
    if ($statement->execute()) {
        ...
        Route::respondError('Failed to create Department record');
    }
...
$department->post('update', function ($data) {
    ...
    $statement->bind_param("ssssssi", $name, $logo_file_path, $banner_file_path, $mission, $vission, $program_educational_objectives, $college_id, $dept_id,);
