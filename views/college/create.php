...
$statement = $conn -> prepare(
    "INSERT INTO college (name, banner_file_path, logo_file_path, organizational_chart_file_path,secretary,email,mission,vission,program_educational_objectives,date_added,date_updated)
     VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)"
);
