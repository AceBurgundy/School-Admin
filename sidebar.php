<nav class="d-flex flex-column flex-shrink-0 p-3 text-white bg-dark">
  <a href="" class="d-flex align-items-center mb-3 mb-md-0 me-md-auto text-white text-decoration-none">
    ...
    <span class="fs-4">RMMC Admin</span>
  </a>
  <hr>
  ...
  <hr>
  <div class="dropdown">
    <a href="".php class="d-flex align-items-center text-white text-decoration-none dropdown-toggle" id="dropdownUser1" data-bs-toggle="dropdown" aria-expanded="false">
